  ...
  var tab, box, email, shown = false, sending = false, openmsg = null, callbacks = {},
    ...
    STYLE =
      ...
      '#CHARM_TAB { '+RESET+'position:fixed;z-index:999999;left:-10px;cursor:pointer;top:50%;margin-top:-100px;width:40px;height:200px;color:#fff;'+
        ';background:url(/assets/feedback.png);background-size:100% 100%;'+
      ...
      '}\n'+
      '@media only screen and (-moz-min-device-pixel-ratio: 1.5), only screen and (-o-min-device-pixel-ratio: 3/2), only screen and (-webkit-min-device-pixel-ratio: 1.5), only screen and (min-device-pixel-ratio: 1.5) { #CHARM_TAB { background-image:url(/assets/feedback2x.png); }}',
    BOX =
